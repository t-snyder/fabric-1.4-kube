...
../../bin/configtxgen -profile GreenChannel -outputAnchorPeersUpdate ./channel-artifacts/green-agencies-green-anchor.tx -channelID green -asOrg Agencies
...
../../bin/configtxgen -profile BlueChannel  -outputAnchorPeersUpdate ./channel-artifacts/blue-agencies-blue-anchor.tx   -channelID blue  -asOrg Agencies
