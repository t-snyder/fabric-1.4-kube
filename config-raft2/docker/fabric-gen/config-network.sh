...
../../bin/configtxgen -profile GreenChannel -outputAnchorPeersUpdate ./channel-artifacts/green-agencies-green-anchor.tx -channelID green -asOrg GreenAgencies
...
../../bin/configtxgen -profile BlueChannel  -outputAnchorPeersUpdate ./channel-artifacts/blue-agencies-blue-anchor.tx   -channelID blue  -asOrg BlueAgencies

../../bin/configtxgen -profile GreenChannel -outputAnchorPeersUpdate ./channel-artifacts/further-green-anchor.tx  -channelID green -asOrg Bsps
../../bin/configtxgen -profile BlueChannel  -outputAnchorPeersUpdate ./channel-artifacts/further-blue-anchor.tx   -channelID blue  -asOrg Bsps
